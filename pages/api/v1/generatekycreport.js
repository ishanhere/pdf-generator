...
import ContractNote_v2 from "../../templates/contractnote_v2";
import moment from "moment";

export default async function handler(req, res) {
  //console.log("/generatekycreport", moment().format("YYYY-MM-DD HH:mm:ss"));
  let browser = null;
  try {
